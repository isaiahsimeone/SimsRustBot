...
item_aliases = [
    ("2133269020", "Red Berry Clone", "red clone"),
    ("2126889441", "Santa Beard"),
    ("2120241887", "Gold Mirror Standing"),
    ("2114754781", "Water Purifier", "purifier"),
    ("2106561762", "Decorative Tinsel", "tinsel"),
    ("2104517339", "Strobe Light", "strobe"),
    ("2100007442", "Audio Alarm"),
    ("2090395347", "Large Solar Panel", "big solar panel", "solar panel big", "solar panel large"),
    ("2087678962", "Search Light", "flood light"),
    ("2070189026", "Large Banner on pole"),
    ("2068884361", "Small Backpack", "backpack small", "little backpack"),
    ("2063916636", "Advanced Ore Tea", "ore tea advanced", "adv ore tea", "ore tea adv"),
    ("2055695285", "Frontier Mirror Medium"),
    ("2054391128", "Factory Door"),
    ("2052270186", "Inner Tube"),
    ("2048317869", "Wolf Skull", "skull wolf"),
    ("2041899972", "Triangle Ladder Hatch", "triangle hatch"),
    ("2040726127", "Combat Knife"),
    ("2024467711", "Pure Scrap Tea", "scrap tea pure"),
    ("2023888403", "Medium Rechargeable Battery", "med battery", "medium battery", "battery medium", "battery med", "med bat", "bat med"),
    ("2021351233", "Advanced Rad. Removal Tea", "adv rad tea", "rad tea adv"),
    ("2019042823", "Tarp"),
    ("2009734114", "Christmas Door Wreath", "xmas wreath"),
    ("2005491391", "Extended Magazine", "ext mag", "big mag"),
    ("1992974553", "Burlap Trousers", "burlap pants", "pants burlap"),
    ("1989785143", "High Quality Horse Shoes", "high qual horse shoe", "high qual horse shoes", "horse shoes hqm", "hqm horse shoes"),
    ("1983621560", "Floor triangle grill", "triangle grill"),
    ("1975934948", "Survey Charge"),
    ("1973949960", "Frontier Bolts Single Item Rack"),
    ("1973684065", "Burnt Chicken"),
    ("1973165031", "Birthday Cake"),
    ("1965232394", "Crossbow", "xbow"),
    ("1953903201", "Nailgun"),
    ("1951603367", "Switch"),
    ("1950721418", "Salvaged Shelves", "shelves", "shelfs"),
    ...
    ("1914691295", "Prototype 17", "glock", "prototype"),
    ("1911552868", "Black Berry Seed"),
    ("1905387657", "Pure Rad. Removal Tea", "pure rad tea", "rad tea pure"),
    ("1903654061", "Small Planter Box", "planter box small", "small planter", "planter small"),
    ("1899610628", "Medium Loot Bag", "medium loot bag"),
    ("1898094925", "Pumpkin Plant Clone", "pumpkin clone"),
    ("1895235349", "Disco Ball"),
    ("1885488976", "Spooky Speaker"),
    ("1883981801", "Medium Quality Pistons"),
    ("1883981800", "High Quality Pistons", "hq pistons", "hqm piston", "high qual pistons"),
    ("1883981798", "Low Quality Pistons", "low qual pistons"),
    ("1882709339", "Metal Blade", "blade"),
    ("1878053256", "Rowboat"),
    ("1877339384", "Burlap Headwrap"),
    ("1874610722", "Armored Cockpit Vehicle Module", "armor cockpit", "armored cockpit"),
    ("1873897110", "Cooked Bear Meat", "bear meat"),
    ("1865253052", "Dracula Mask"),
    ("1856217390", "Egg Basket"),
    ("1850456855", "Road Sign Kilt", "kilt"),
    ("1849887541", "Small Generator", "generator"),
    ...
    ("1729374708", "Pure Ore Tea", "ore tea pure"),
    ("1729120840", "Wooden Door", "wood door", "door wooden", "door wood"),
    ("1723747470", "Tree Lights"),
    ("1722154847", "Hide Pants"),
    ("1719978075", "Bone Fragments"),
    ("1714496074", "Candle Hat"),
    ("1712261904", "Pure Max Health Tea", "max health pure", "pure max health", "pure health"),
    ("1712070256", "HV 5.56 Rifle Ammo", "HV rifle ammo", "rifle ammo HV", "HV 5.56"),
    ...
    ("1659447559", "Wooden Horse Armor", "wood horse armor", "wood horse armour", "wooden horse armour"),
    ("1659114910", "Gas Mask"),
    ("1658229558", "Lantern"),
    ("1655979682", "Empty Can Of Beans", "empty bean can", "bean can empty"),
    ...
    ("1588492232", "Drone"),
    ("1588298435", "Bolt Action Rifle", "BAR", "bolty", "bolt"),
    ("1581210395", "Large Planter Box", "planter large", "large planter"),
    ("1575635062", "Frankenstein Table"),
    ("1572152877", "Mint ID Tag"),
    ("1569882109", "Handmade Fishing Rod", "fishing rod"),
    ("1568388703", "Diesel Fuel", "diesel"),
    ("1561022037", "Abyss Metal Pickaxe"),
    ("1559915778", "Single Horse Saddle"),
    ("1559779253", "Engine Vehicle Module"),
    ("1557173737", "Sunglasses"),
    ("1556365900", "Molotov Cocktail", "molly", "molotov"),
    ("1553078977", "Bleach"),
    ("1548091822", "Apple"),
    ("1545779598", "Assault Rifle", "ak", "ak47", "ar"),
    ("1542290441", "Single Sign Post"),
    ("1540934679", "Wooden Spear", "spear wood", "spear"),
    ("1538126328", "Industrial Combiner", "pipe combiner"),
    ("1536610005", "Cooked Human Meat"),
    ("1534542921", "Chair"),
    ("1533551194", "White Berry Clone"),
    ("1525520776", "Building Plan"),
    ("1524980732", "Carvable Pumpkin"),
    ("1524187186", "Workbench Level 1", "workbench 1", "workbench one"),
    ("1523403414", "Cassette - Short"),
    ("1523195708", "Targeting Computer", "laptop"),
    ("1521286012", "Double Sign Post"),
    ("1516985844", "Netting"),
    ("1512054436", "Potato Clone"),
    ("1491753484", "Medium Frankenstein Torso"),
    ("1491189398", "Paddle"),
    ("1488979457", "Jackhammer", "jacky"),
    ("1480022580", "Basic Ore Tea", "ore tea basic"),
    ("1478091698", "Muzzle Brake"),
    ("1463862472", "Wanted Poster 4"),
    ("1451568081", "Chainlink Fence Gate"),
    ("1443579727", "Hunting Bow"),
    ("1430085198", "Industrial Crafter", "crafter"),
    ...
    ("1397052267", "Supply Signal", "airdrop"),
    ("1394042569", "RHIB"),
    ("1391703481", "Burnt Pork"),
    ("1390353317", "Sheet Metal Double Door", "double door", "sheet double door", "double door sheet", "sheetmetal door double"),
    ...
    ("1353298668", "Armored Door", "HQM door", "high qual door", "high quality door"),
    ("1346158228", "Pumpkin Bucket"),
    ("1330084809", "Low Quality Valves", "low qual valves"),
    ("1327005675", "Short Ice Wall"),
    ("1326180354", "Salvaged Sword"),
    ("1324203999", "Champagne Boomer"),
    ("1319617282", "Small Loot Bag"),
    ("1318558775", "MP5A4", "mp5"),
    ("1315082560", "Ox Mask"),
    ("1312843609", "Skull"),
    ...
    ("1266491000", "Hazmat Suit", "hazmat", "hazzy"),
    ("1263920163", "Smoke Grenade"),
    ("1259919256", "Mixing Table"),
    ("1258768145", "Sunglasses"),
    ("1248356124", "Timed Explosive Charge", "c4", "BOOM!"),
    ("1242522330", "Cursed Cauldron"),
    ("1242482355", "Jack O Lantern Angry"),
    ("1234880403", "Sewing Kit", "sew kit", "sewing kit", "sk"),
    ("1234878710", "Telephone"),
    ("1230691307", "Captain's Log"),
    ("1230323789", "SMG Body", "body smg"),
    ("1223900335", "Dog Tag"),
    ("1223729384", "Lavender ID Tag"),
    ("1221063409", "Armored Double Door", "high qual double door", "armoured double door", "double door armour", "double door armor"),
    ("1205607945", "Two Sided Hanging Sign"),
    ("1205084994", "Large Photo Frame"),
    ("1199391518", "Road Signs", "signs", "rs"),
    ("1189981699", "Crate Costume"),
    ("1186655046", "Fuel Tank Vehicle Module"),
    ("1181207482", "Heavy Plate Helmet", "heavy helmet", "helmet heavy", "heavy facemask"),
    ("1177596584", "Elevator"),
    ("1176355476", "Concrete Hatchet"),
    ("1171735914", "AND Switch"),
    ("1168856825", "Metal Detector"),
    ("1160881421", "Hitch & Trough"),
    ("1159991980", "Code Lock", "code"),
    ("1158340334", "Low Quality Crankshaft"),
    ("1158340332", "High Quality Crankshaft", "high qual crankshaft", "hq crankshaft"),
    ...
    ("1110385766", "Metal Chest Plate", "chestplate", "metal chest"),
    ...
    ("1081315464", "Nest Hat"),
    ("1079279582", "Medical Syringe", "medstick", "syringe"),
    ...
    ("795371088", "Pump Shotgun", "pump", "pumpy"),
    ("795236088", "Torch"),
    ("794443127", "Christmas Tree", "xmas tree"),
    ("794356786", "Hide Boots"),
    ("785728077", "Pistol Bullet", "pistol ammo", "bullet pistol", "pistol bullets", "pistol shots"),
    ("782422285", "Sofa - Pattern"),
    ("762289806", "Siren Light"),
    ("756517185", "Medium Present"),
    ("756125481", "Wood Mirror Medium"),
    ("755224797", "Vodka Bottle", "vodka"),
    ("742745918", "Industrial Splitter", "pipe splitter"),
    ...
    ("649912614", "Revolver", "revo"),
    ("642482233", "Sticks"),
    ("634478325", "CCTV Camera", "camera", "cctv"),
    ("621915341", "Raw Pork"),
    ("615112838", "Rail Road Planter"),
    ("613961768", "Bota Bag"),
    ("610102428", "Industrial Conveyor", "conveyor"),
    ("609049394", "Battery - Small", "small battery", "battery small", "small bat", "little bat"),
    ("607400343", "Legacy Wood Shelter"),
    ("605467368", "Incendiary 5.56 Rifle Ammo", "inced 5.56", "incend rifle ammo", "rifle inced", "incendiary rifle ammo"),
    ("603811464", "Advanced Max Health Tea", "adv max health tea", "max health tea advanced", "advanced health tea", "adv health tea"),
    ...
    ("573926264", "Semi Automatic Body", "semi body", "body semi", "body semi automatic"),
    ("573676040", "Coffin"),
    ("567871954", "Secret Lab Chair"),
    ("567235583", "8x Zoom Scope", "4x", "8x"),
    ("559147458", "Survival Fish Trap"),
    ("553887414", "Skull Fire Pit"),
    ("553270375", "Large Rechargeable Battery", "large battery", "battery large"),
    ("550753330", "Snowball"),
    ("528668503", "Flame Turret"),
    ("524678627", "Advanced Scrap Tea", "scrap tea adv", "adv scrap tea"),
    ("492357192", "RAND Switch"),
    ("491263800", "Nomad Suit", "nomad"),
    ("486661382", "Clan Table"),
    ("479292118", "Large Loot Bag"),
    ("479143914", "Gears", "gear"),
    ...
    ("442886268", "Rocket Launcher", "launcher"),
    ("442289265", "Holosight", "holo"),
    ("418081930", "Wood Chestplate"),
    ("390728933", "Yellow Berry Clone"),
    ("363163265", "Hose Tool"),
    ("359723196", "Chippy Arcade Game"),
    ("352499047", "Shotgun Trap", "shotty trap"),
    ("352321488", "Sunglasses"),
    ("352130972", "Rotten Apple"),
    ("349762871", "40mm HE Grenade"),
    ("343045591", "MLRS Aiming Module", "aiming module"),
    ("342438846", "Anchovy"),
    ("340210699", "Frontier Mirror Small"),
    ("317398316", "High Quality Metal", "hqm", "high qual", "high qual metal"),
    ("304481038", "Flare"),
    ...
    ("263834859", "Basic Scrap Tea", "scrap tea basic"),
    ("261913429", "White Volcano Firework"),
    ("254522515", "Large Medkit", "medkit"),
    ...
    ("204391461", "Coal 🙁"),
    ("200773292", "Hammer"),
    ("198438816", "Vending Machine", "vending"),
    ("196700171", "Hide Vest"),
    ("192249897", "Green"),
    ("190184021", "Kayak"),
    ...
    ("177226991", "Scarecrow"),
    ("176787552", "Rifle Body", "rb", "body rifle"),
    ("174866732", "16x Zoom Scope", "16x", "16 zoom"),
    ("171931394", "Stone Pickaxe", "stone pick"),
    ("170758448", "Cockpit With Engine Vehicle Module"),
    ("143803535", "F1 Grenade", "F1", "grenade"),
    ...
    ("70102328", "Red ID Tag"),
    ("69511070", "Metal Fragments", "frags", "metal frags"),
    ("62577426", "Photograph"),
    ("60528587", "Roadsign Horse Armor"),
    ("51984655", "Incendiary Pistol Bullet", "inced pistol ammo", "pistol ammo inced"),
    ("42535890", "Medium Animated Neon Sign"),
    ("39600618", "Microphone Stand"),
    ("37122747", "Green Keycard", "greencard", "green card"),
    ("28201841", "M39 Rifle", "m39", "mthirtynine"),
    ("23391694", "Bunny Hat"),
    ...
    ("-33009419", "Pure Anti-Rad Tea", "pure rad tea", "rad tea pure"),
    ("-41440462", "Spas-12 Shotgun", "spas", "spas12", "spas-12"),
    ("-41896755", "Workbench Level 2", "workbench 2"),
    ...
    ("-132516482", "Weapon Lasersight", "laser"),
    ("-134959124", "Light Frankenstein Head"),
    ("-135252633", "Sled"),
    ("-139037392", "Abyss Assault Rifle"),
    ("-143132326", "Huge Wooden Sign"),
    ("-144417939", "Wire Tool", "wiring"),
    ("-144513264", "Pipe Tool", "piping"),
    ("-148229307", "Metal Shop Front"),
    ("-148794216", "Garage Door", "gdoor", "garage"),
    ("-151387974", "Deluxe Christmas Lights"),
    ("-151838493", "Wood"),
    ("-156748077", "Skull Trophy"),
    ("-173268125", "Rustige Egg - Green"),
    ("-173268126", "Rustige Egg - Ivory"),
    ("-173268128", "Rustige Egg - White"),
    ("-173268129", "Rustige Egg - Red"),
    ("-173268131", "Rustige Egg - Purple"),
    ("-173268132", "Rustige Egg - Blue"),
    ("-176608084", "Sunglasses"),
    ("-180129657", "Wood Storage Box", "small wooden box", "wood box small"),
    ("-187031121", "Solo Submarine"),
    ("-194509282", "Butcher Knife"),
    ("-194953424", "Metal Facemask"),
    ("-196667575", "Flashlight", "weapon light"),
    ...
    ("-470439097", "Arctic Suit", "arctic"),
    ("-484206264", "Blue Keycard", "blue card"),
    ("-487356515", "Anti-Rad Tea"),
    ("-489848205", "Large Candle Set"),
    ("-493159321", "Medium Quality Spark Plugs"),
    ("-496584751", "Rad. Removal Tea", "rad tea"),
    ...
    ("-555122905", "Sofa"),
    ("-557539629", "Pure Wood Tea", "wood tea pure"),
    ...
    ("-586784898", "Mail Box"),
    ("-587989372", "Catfish"),
    ("-592016202", "Explosives", "xplosives"),
    ("-596876839", "Spray Can"),
    ...
    ("-682687162", "Burnt Human Meat", "keyanuish meat"),
    ...
    ("-765183617", "Double Barrel Shotgun", "db", "double barrel"),
    ("-769647921", "Skull Trophy"),
    ("-770304148", "Chinese Lantern White"),
    ("-778367295", "L96 Rifle", "l9", "l96"),
    ...
    ("-904863145", "Semi-Automatic Rifle", "sar", "semi", "semi rifle"),
    ("-907422733", "Large Backpack", "backpack large"),
    ...
    ("-946369541", "Low Grade Fuel", "low grade", "lgf", "fuel"),
    ...
    ("-1021495308", "Metal Spring", "spring", "springs"),
    ("-1022661119", "Baseball Cap"),
    ("-1023065463", "High Velocity Arrow"),
    ("-1023374709", "Wood Shutters"),
    ("-1036635990", "12 Gauge Incendiary Shell", "shotgun incend"),
    ("-1039528932", "Small Water Bottle", "small bottle"),
    ...
    ("-1157596551", "Sulfur Ore", "ore sulfur", "sulf ore", "sulfo"),
    ...
    ("-1184406448", "Basic Max Health Tea", "health tea basic", "basic health tea"),
    ("-1196547867", "Electric Furnace"),
    ("-1199897169", "Metal horizontal embrasure"),
    ("-1199897172", "Metal Vertical embrasure"),
    ("-1211166256", "5.56 Rifle Ammo", "rifle ammo", "5.56"),
    ...
    ("-1367281941", "Waterpipe Shotgun", "waterpipe"),
    ("-1368584029", "Sickle"),
    ...
    ("-1517740219", "Speargun"),
    ("-1518883088", "Night Vision Goggles", "nvg"),
    ("-1519126340", "Drop Box"),
    ...
    ("-1581843485", "Sulfur", "sulf", "cooked sulfur"),
    ("-1583967946", "Stone Hatchet"),
    ("-1588628467", "Computer Station"),
    ("-1607980696", "Workbench Level 3", "workbench 3", "tier 3 workbench"),
    ...
    ("-1654233406", "Sardine"),
    ("-1663759755", "Homemade Landmine", "landmine"),
    ("-1667224349", "Decorative Baubels"),
    ("-1671551935", "Torpedo"),
    ("-1673693549", "Empty Propane Tank"),
    ("-1677315902", "Pure Healing Tea", "healing tea"),
    ("-1679267738", "Graveyard Fence"),
    ("-1683726934", "Two-Way Mirror"),
    ("-1685290200", "12 Gauge Buckshot", "buckshot"),
    ("-1691396643", "HV Pistol Ammo", "hv pistol", "pistol hv ammo"),
    ...
    ("-1729415579", "Adv. Anti-Rad Tea", "rad tea advanced", "advanced rad tea"),
    ...
    ("-1841918730", "High Velocity Rocket", "hv rocket", "rocket hv"),
    ("-1843426638", "MLRS Rocket"),
    ("-1848736516", "Cooked Chicken"),
    ("-1850571427", "Silencer", "suppressor"),
    ...
    ("-1880870149", "Red Keycard", "red card"),
    ...
    ("-1938052175", "Charcoal", "charc"),
    ("-1941646328", "Can of Tuna", "tuna can"),
    ...
    ("-1982036270", "High Quality Metal Ore", "hqm ore", "high qual ore", "high quality ore"),
    ("-1985799200", "Rug"),
    ...
    ("-2069578888", "M249", "m2"),
    ("-2072273936", "Bandage", "bandaide"),
    ("-2073432256", "Skinning Knife"),
    ("-2084071424", "Potato Seed"),
    ("-2086926071", "Potato"),
    ("-2094954543", "Wood Armor Helmet"),
    ("-2097376851", "Nailgun Nails", "nails"),
    ("-2099697608", "Stones", "stone"),
    ("-2103694546", "Sunglasses"),
    ("-2107018088", "Shovel Bass"),
    ("-2123125470", "Advanced Healing Tea", "healing tea advanced", "adv healing tea"),
    ("-2124352573", "Acoustic Guitar"),
    ("-2139580305", "Auto Turret", "turret")
]

import difflib
class RustItemNameManager:
    def __init__(self):
        self.name_to_id = {}  # Maps item names and aliases to item_id, case-insensitively
    ...
    def normalise_alias(self, alias):
        ...
        normalised.add(alias.replace(" ", "").lower())
        return normalised
    ...
    def add_item_with_aliases(self, item_id_, item_name, *additional_aliases):
        ...
        for alias in additional_aliases:
            normalised_aliases.update(self.normalise_alias(alias))
        
        # Update name_to_id for lookup by name/alias
        for alias in normalised_aliases:
            self.name_to_id[alias] = item_id
        
        # Update id_to_names for reverse lookup from ID to names/aliases
        if item_id not in self.id_to_names:
            self.id_to_names[item_id] = set()
    ...
    def get_aliases_for_name(self, name):
        ...
        if item_id:
            return self.get_aliases_for_id(item_id)
        return []
    ...
    def suggest_closest_match(self, name):
        ...
        closest_matches = difflib.get_close_matches(name.lower(), all_names, n=1, cutoff=0.0)
        if closest_matches:
    ...
    def __str__(self):
        ...
        dump_str = []
        for item_id, names in self.id_to_names.items():
            names_str = ", ".join(sorted(names))  # Sort names for consistent output
            dump_str.append(f"Item ID {item_id}: {names_str}")
        return "\n".join(dump_str)